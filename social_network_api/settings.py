...
SECRET_KEY = "django-insecure-^oo3m&22ja57cf!(-a$34r)+knh^6wa5l&wz63ofat5s%s)vzk"
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": (
        "API allows users to create and manage posts,"
        " like posts, and maintain user accounts."
    ),
    "VERSION": "1.0.0",
